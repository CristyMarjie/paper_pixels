    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                ...
                <span class="text-muted pt-2 font-size-sm d-block">Tenant List</span></h3>
            </div>
                ...
                <div class="dropdown dropdown-inline mr-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                        ...
                        <ul class="navi flex-column navi-hover py-2">
                            <li class="navi-item">
                                <a href="{{route('download.tenants')}}" target="_blank" class="navi-link">
        ...
        <div class="card-body">
            <table id="tenantList" class="table align-middle table-row-dashed fs-6 gy-5">
                <thead>

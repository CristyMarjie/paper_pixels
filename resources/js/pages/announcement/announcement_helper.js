class AnnouncementHelper {
    ...
    getAnnouncements = async (container) =>{

        const {data:Announcements} = await axios.get(`/announcement/list`)
        ...
        Announcements.forEach(Announcement => {
            ...
            <div class="card-header" id="faqHeading1">
                <div class="card-title font-size-h4 text-dark" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1" role="button">
                    <div class="card-label">${Announcement.title}</div>
            ...
            <div id="faq1" class="collapse show" aria-labelledby="faqHeading1" data-parent="#faq">
                <div class="card-body pt-3 font-size-h6 font-weight-normal text-dark-50">${Announcement.description}.</div>
            </div>
